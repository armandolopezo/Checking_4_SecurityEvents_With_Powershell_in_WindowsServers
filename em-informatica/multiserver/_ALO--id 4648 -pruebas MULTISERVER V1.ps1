...
Write-Host "*** Eventos en $($env:COMPUTERNAME) *** "
...
For ($x = 0; $x -lt $ArrayMaximumSize; $x = $x + 1)
   {
    ...
    $NewArrayList[$x] = [PSCustomObject]@{
     ...
     $FilteredArray[$z] = [PSCustomObject]@{
      ...
      # the following 30 lines shoWED FIELDS in the edition v18 of thESE scripts. in this edition V19 I commented commands FOR AVOIDING DISPLAYING FIELDS
