...
write-host " *********************************************************************************************************************************************************** "
write-host ' las siguientes lineas comando muestran las PROPIEDADES Y METODOS DEL ARREGLO RESULT QUE CONTIENE EN CADA INDICE los EVENTOS OBTENIDOS con get-eventlog ' 
# Get-EventLog -LogName Security -InstanceId 4648|Get-Member  --> este comando no me muestra nada, PERO SI EL SIGUIENTE SIN USAR INSTANCEID
...
$result = Get-EventLog -LogName Security -InstanceId 4648
