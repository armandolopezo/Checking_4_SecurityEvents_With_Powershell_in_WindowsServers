...
$result2=$result | Select-Object Time, Machine, User, Access, SourceAddr


$SourceIpAddresses=$result2 | Select-Object SourceAddr
...
# La propiedad VALUES de la linea siguiente no hace falta (VALUES property is not needed because it is repited).
